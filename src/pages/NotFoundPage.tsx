...
export function NotFoundPage() {
  usePageMeta({
    title: "404 | Portfolio",
    description: "Página não encontrada no portfólio de João Victor Alves de Abreu.",
    path: "/404",
  });
      ...
      <div className="mx-auto max-w-4xl px-5 py-24 lg:px-8">
        <div className="glass-card text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-600 dark:text-slate-300">
            O link solicitado não está disponível. Volte para a página principal e continue a navegação pelo portfólio.
          </p>
